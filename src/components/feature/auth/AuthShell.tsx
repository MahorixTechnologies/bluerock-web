  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-[var(--bg)] px-4 py-10 text-[var(--text)]">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="absolute -bottom-40 -right-32 h-[480px] w-[480px] rounded-full bg-[var(--sidebar)]/10 blur-3xl" />
      ...
      >
        <div className="flex flex-col items-center">
          <span className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--primary)]/12 text-2xl font-black text-[var(--primary)] shadow-[0_8px_24px_rgba(30,91,255,0.15)]">
            ◈
          </span>
          <p className="mt-3 text-[10px] font-black uppercase tracking-[0.36em] text-[var(--sidebar)]/60">
            BlueRock
          </p>
        </div>
        ...
        {(title || subtitle) ? (
          <div className="mt-7 text-center">
            {title ? (
              <h1 className="text-[26px] font-black tracking-tight text-[var(--text)] sm:text-[28px]">
                {title}
              </h1>
            ) : null}
            {subtitle ? (
      ...
      <footer className="relative z-10 mt-14 text-center text-[10px] font-black uppercase tracking-[0.38em] text-[var(--muted-2)]">
